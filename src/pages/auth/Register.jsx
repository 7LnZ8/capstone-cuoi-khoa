    ...
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh', backgroundColor: '#f0f2f5' }}>
      <Card style={{ width: 500, boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>
        <div style={{ textAlign: 'center', marginBottom: 20 }}>
           ...
           <Text type="secondary">Tạo tài khoản để bắt đầu học ngay hôm nay</Text>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div style={{ marginBottom: 16 }}>
            <Controller
              ...
              control={control}
              render={({ field }) => (
                <Input {...field} prefix={<UserOutlined />} placeholder="Tài khoản" size="large" />
              )}
            />
          ...
          <div style={{ marginBottom: 16 }}>
            <Controller
              ...
              control={control}
              render={({ field }) => (
                <Input {...field} prefix={<IdcardOutlined />} placeholder="Họ tên" size="large" />
              )}
            />
            {errors.hoTen && <span style={{ color: "red", fontSize: 12 }}>{errors.hoTen.message}</span>}
          </div>
          ...
          <div style={{ marginBottom: 24 }}>
            <Controller
              ...
              control={control}
              render={({ field }) => (
                <Input {...field} prefix={<PhoneOutlined />} placeholder="Số điện thoại" size="large" />
              )}
            />
            {errors.soDT && <span style={{ color: "red", fontSize: 12 }}>{errors.soDT.message}</span>}
          </div>
