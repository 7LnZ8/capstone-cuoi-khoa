...
import { CodeOutlined, LaptopOutlined, MobileOutlined, ApiOutlined, GlobalOutlined } from "@ant-design/icons";
...
export default function CategoryList() {
  ...
  const getIcon = (index) => {
    const icons = [<CodeOutlined />, <LaptopOutlined />, <MobileOutlined />, <ApiOutlined />, <GlobalOutlined />];
